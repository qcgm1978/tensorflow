...
CREATE TABLE `formulas` (
  `degreeCoefs` json NOT NULL,
  `points` bigint DEFAULT NULL,
  `iterations` int DEFAULT '75',
...
INSERT INTO `formulas` VALUES ('[{\"coef\": 3, \"degree\": 2}, {\"coef\": 4, \"degree\": 0}]',10,15,1,1,NULL,NULL,NULL);
...
-- Dump completed on 2020-08-26 21:11:05
